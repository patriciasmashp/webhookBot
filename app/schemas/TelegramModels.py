...
class InlineKeyboardButton(BaseModel):
    ...
    login_url: Optional[LoginUrl] = Field(None)
    callback_data: Optional[str] = Field(None)
    switch_inline_query: Optional[str] = Field(None)
    switch_inline_query_current_chat: Optional[str] = Field(None)
    callback_game: Optional[CallbackGame] = Field(None)
    pay: Optional[bool] = Field(None)
...
class MessageToSend(BaseModel):
    ...
    reply_markup: Union[InlineKeyboardMarkup, ReplyKeyboardMarkup,
                        ...
                        List] = Field(InlineKeyboardMarkup(inline_keyboard=[]))

    @field_serializer('reply_markup')
    def serialize_reply_markup(
        self, value: Union[InlineKeyboardMarkup, ReplyKeyboardMarkup,
                           ReplyKeyboardRemove, ForceReply, List]
    ) -> Union[dict, str]:
...
class ChatMemberUpdated(BaseModel):
    ...
    from_user: User = Field(alias='from')
    date: datetime
    old_chat_member: Union[ChatMemberOwner, ChatMemberAdministrator,
                           ChatMemberMember, ChatMemberRestricted,
                           ChatMemberLeft, ChatMemberBanned]
    new_chat_member: Union[ChatMemberOwner, ChatMemberAdministrator,
                           ChatMemberMember, ChatMemberRestricted,
                           ChatMemberLeft, ChatMemberBanned]
...
At most one of the optional parameters can be present in any given update.
    ...
    def get_event_by_name(self, event):
